      ...
      <div class="container">
        ...
        <div class="section-header">
          ...
          <div class="section-info">
            <h2 class="section-title">Medium Maps</h2>
            <p class="section-description">Perfect balance of action and strategy for all skill levels</p>
          </div>
        </div>
            ...
            <div class="card-image-container">
              ...
              <div class="card-overlay">
                <div class="overlay-content">
                  ...
                  <div class="map-size-badge medium">Medium</div>
                </div>
              </div>
              <div class="card-badges">
                <div class="size-badge medium">M</div>
...
.hero-header::before {
  ...
  right: 0;
  bottom: 0;
  background: url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><defs><pattern id="grain" width="100" height="100" patternUnits="userSpaceOnUse"><circle cx="50" cy="50" r="1" fill="rgba(255,193,7,0.1)"/></pattern></defs><rect width="100" height="100" fill="url(%23grain)"/></svg>');
  opacity: 0.3;
}
