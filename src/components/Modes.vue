<template>
  ...
  <div class="row text-white">
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Hybrud-Samurai.webp" class="img-fluid rounded" width="100%" height="400" alt="Zombie Mode">
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Armageddon.webp" class="img-fluid rounded" width="100%" height="400" alt="Deathmatch">
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Plague-Mode.webp" class="img-fluid rounded" width="100%" height="400" alt="Classic Mode">
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Cannibal.webp" class="img-fluid rounded" width="100%" height="400" alt="Classic Mode">
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Tag.webp" class="img-fluid rounded" width="100%" height="400" alt="Classic Mode">
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Swarm.webp" class="img-fluid rounded" width="100%" height="400" alt="Classic Mode">
