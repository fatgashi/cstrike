<template>
  ...
  <h2 class="text-center mb-4" id="title">Explore Game Modes</h2>
  <div class="row text-white">
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      ...
      <h4 id="title" class="mt-3">Hybrid vs Samurai</h4>
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      ...
      <h4 id="title" class="mt-3">Armageddon Mode</h4>
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      ...
      <h4 id="title" class="mt-3">Plague Mode</h4>
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      ...
      <h4 id="title" class="mt-3">Cannibal Mode</h4>
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      ...
      <h4 id="title" class="mt-3">Tag Mode</h4>
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      ...
      <h4 id="title" class="mt-3">Swarm Mode</h4>
