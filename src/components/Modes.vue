<template>
  ...
  <div class="row text-white">
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Hybrud-Samurai.webp" class="img-fluid rounded" loading="lazy" width="400" height="400" alt="Hybrid vs Samurai Mode">
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Armageddon.webp" class="img-fluid rounded" loading="lazy" width="400" height="400" alt="Armageddon Mode">
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Plague-Mode.webp" class="img-fluid rounded" loading="lazy" width="400" height="400" alt="Plague Mode">
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Cannibal.webp" class="img-fluid rounded" loading="lazy" width="400" height="400" alt="Cannibal Mode">
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Tag.webp" class="img-fluid rounded" loading="lazy" width="400" height="400" alt="Tag Mode">
    ...
    <div class="col-md-4 col-12 text-center mb-3" id="photo">
      <img src="../assets/modes/Swarm.webp" class="img-fluid rounded" loading="lazy" width="400" height="400" alt="Swarm Mode">
